...
class design(KnowledgeEngine):
    ...
    def ask_budget(self):
        ...
        api = "http://192.168.56.1:8000/expert/get_u_budget/"
    ...
    def ask_space32(self):
        ...
        api = "http://192.168.56.1:8000/expert/get_space/"
    ...
    def ask_sun1(self):
        ...
        api = "http://192.168.56.1:8000/expert/get_sun1/"
    ...
    def ask_color11(self):
        ...
        api = "http://192.168.56.1:8000/expert/get_color1/"
    ...
    def ask_color22(self):
        ...
        global choices
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
        api = "http://192.168.56.1:8000/expert/get_color2/"
        choices=['1- prefer dark colors','2- prefer bright colors' ]
    @Rule(Fact(color2="1"))
    def Design91(self):
            global api
    ...
    def  ask_color33(self):
        ...
        global choices
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
        api = "http://192.168.56.1:8000/expert/get_color3/"
        choices=['1- prefer dark colors','2- prefer bright colors' ]
    @Rule(Fact(color3="1"))
    def Design11(self):
            global api
    ...
    def ask_sun24(self):
            global api
            api = "http://192.168.56.1:8000/expert/get_sun2/"
            self.declare(Fact(response="Does the sun enter the room ?\n 1-Yes 2-medium 3-No"))
    @Rule(Fact(sun2="1"))
    def ask_color44(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_color4/"
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
    @Rule(Fact(color4="1"))
    def Design77(self):
            global api
    ...
    def ask_colorss(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_color5/"
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
    @Rule(Fact(color5="1"))
    def Design49(self):
            global api
    ...
    def  ask_color66(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_color6/"
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n")) 
    @Rule(Fact(color6="1"))
    def Design131(self):  
        global api
    ...
    def ask_budget24(self):
        global api
        global choices
        api = "http://192.168.56.1:8000/expert/get_your_budget/"
        choices=['1-more than 3500','2-less than 2355']
        self.declare(Fact(response="is your budget 1-more than 3500  2-less than 3500?\n"))
    @Rule(Fact(your_budget="1"))
    def ask_space11(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_space1/"
        self.declare(Fact(response="Does the room need a play area? 1- >11 m  2- <11 m \n"))
    @Rule(Fact(space1="1"))
    def ask_type1(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_room_type1/"
    ...
    def play1(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play1/"
    ...
    def play2ed(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play2/"
        self.declare(Fact(response="Does the room need a play area?? 1-yes  2-no \n"))
    @Rule(Fact(play2="1"))
    def Design33(self):
        global api
    ...
    def ask_special212(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_special2_1/"
        self.declare(Fact(response="Are there special needs to be considered? Like allergies or disabilities? 1-yes  2-no"))
    @Rule(Fact(special2_1="1"))
    def play32(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play3/"
        self.declare(Fact(response="Does the room need a play area?? 1-yes  2-no"))
    @Rule(Fact(play3="1"))
    def Design5(self):
        global api
    ...
    def play4(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play4/"
        self.declare(Fact(response="Does the room need a play area?? 1-yes  2-no"))
    @Rule(Fact(play4="1"))
    def Design7(self):
        global api
    ...
    def ask_num29(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_num2/"
        self.declare(Fact(response="How many children will be sharing the room? 1- (1 or 2) 2-(3 or 4)"))
    @Rule(Fact(num2="1") )
    def ask_special3_1(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_special3_1/"
        self.declare(Fact(response="Are there special needs to be considered? Like allergies or disabilities? 1-yes  2-no"))
    @Rule(Fact(special3_1="1"))
    def play5(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play5/"
        self.declare(Fact(response="Does the room need a play area?? 1-yes  2-no"))
    @Rule(Fact(play5="1"))
    def Design94(self):
        global api
    ...
    def play6(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play6/"
        self.declare(Fact(response="Does the room need a play area?? 1-yes  2-no"))
    @Rule(Fact(play6="1"))
    def Design11(self):
        global api
    ...
    def ask_special3_2(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_special3_2/"
        self.declare(Fact(response="Are there special needs to be considered? Like allergies or disabilities? 1-yes  2-no"))
    @Rule(Fact(special3_2="1"))
    def play7(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play7/"
        self.declare(Fact(response="Does the room need a play area?? 1-yes  2-no \n"))
    @Rule(Fact(play7="1"))
    def Design13(self):
        global api
    ...
    def play8(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_play8/"
        self.declare(Fact(response="Does the room need a play area?? 1-yes  2-no \n"))
    @Rule(Fact(play8="1"))
    def Design15(self):
        global api
    ...
    def ask_age(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_age2_1/"
        self.declare(Fact(response="what is age rang of children : 1- >12  2- <12 ?\n"))
    @Rule(Fact(age2_1="1"))
    def ask_num2_1(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_num2_1/"
        self.declare(Fact(response="How many children will be sharing the room? 1- (1 or 2) 2-(3 or 4)\n"))
    @Rule(Fact(num2_1="1"))
    def ask_color21(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_color21/"
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
    @Rule(Fact(color21="1"))
    def Design17(self):
        global api
    ...
    def  ask_colore(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_color22/"
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
    @Rule(Fact(color22="1"))
    def Designr3(self):
        global api
    ...
    def ask_num2_144(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_num2_2/"
        self.declare(Fact(response="How many children will be sharing the room? 1- (1 or 2) 2-(3 or 4)\n"))
    @Rule(Fact(num2_2="1"))
    def ask_color3_1(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_color31/"
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
    @Rule(Fact(color31="1"))
    def Design17(self):
        global api
    ...
    def ask_color3_2(self):
        global api
        api = "http://192.168.56.1:8000/expert/get_color32/"
        self.declare(Fact(response="Which colors do you prefer ?\n 1-Dark colors  2-Bright colors \n"))
    @Rule(Fact(color32="1"))
    def Design17(self):
        global api
