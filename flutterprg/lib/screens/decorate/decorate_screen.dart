...
class _DecorateState extends State<Decorate> {
  ...
  Future<void> _Decrorate() async {
    ...
    //String downloadUrl =
    //    'http://192.168.56.1:8000/media/generated_scenes/Bedroom-18759_115_000.png'; // استبدله برابط التحميل الفعلي
    ...
    var response1 = await dio.post('http://192.168.56.1:8000/model/', data: data);
